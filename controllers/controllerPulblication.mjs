...
export const deletePublication = async (req, res) => {
    try {
        ...
        const publicationId = req.params.publicationId; // Obtener el ID de la publicación a eliminar
        const publicationIndex = user.publication.findIndex(pub => pub.userId === publicationId);
